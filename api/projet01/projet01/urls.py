...
urlpatterns = [
    ...
    path('partage/all-users/', api.UtilisateurListView.as_view(), name='all-users-list'),
    path('partage/', api.UtilisateurPartageListAPIView.as_view(), name='shared_users_list'),
